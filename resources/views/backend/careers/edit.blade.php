            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('backend.careers.update', $career->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                        placeholder="Title" value="{{ old('title', $career->title) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="start_date" class="form-control @error('start_date') is-invalid @enderror"
                                                value="{{ old('start_date', $career->start_date ?? '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="end_date" class="form-control @error('end_date') is-invalid @enderror"
                                                value="{{ old('end_date', $career->end_date ?? '') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="is_publish" class="form-control @error('is_publish') is-invalid @enderror">
                                        ...
                                        <option value="Publish" {{ old('is_publish', $career->is_publish) == 'Publish' ? 'selected' : '' }}>Publish</option>
                                        <option value="Draft" {{ old('is_publish', $career->is_publish) == 'Draft' ? 'selected' : '' }}>Draft</option>
                                    </select>
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="{{ route('backend.careers.index') }}" class="btn btn-secondary">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
